export default function Home() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-gradient-to-br from-white to-gray-100">
            <div className="z-10 max-w-5xl w-full items-center justify-center text-center font-mono text-sm">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    <a
                        href="/login"
                        className="rounded-full bg-blue-600 px-8 py-4 text-sm font-semibold text-white shadow-xl hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition-all transform hover:scale-105 active:scale-95"
                    >
                        Get Started
                    </a>
            ...
            <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl px-4">
                {[
                    ...
                    <div key={i} className="p-8 bg-white/80 backdrop-blur-sm rounded-3xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
