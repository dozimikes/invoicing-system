...
let InvoicesController = class InvoicesController {
    ...
    async create(createInvoiceDto) {
        return this.invoicesService.create(createInvoiceDto.clientId, createInvoiceDto.amount, createInvoiceDto.description);
    }
    async findAll() {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], InvoicesController.prototype, "findByClient", null);
__decorate([
    (0, common_1.Get)(':id'),
